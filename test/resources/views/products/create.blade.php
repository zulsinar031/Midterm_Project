<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-5 px-7">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-white">Add Product</h2>
        </div>
        <div class="mt-4" x-data="{ imageUrl: '/storage/noimage.png' }">
            <form enctype="multipart/form-data" method="POST" action="{{ route('products.store')}}" class="flex gap-10">
                @csrf
                <div class="w-1/2">
