<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-5 px-7">
        ...
        <div class="mt-4" x-data="{ imageUrl: '/storage/{{ $product->foto }}'}">
            <form enctype="multipart/form-data" method="POST" action="{{ route('products.update', $product)}}" class="flex gap-10">
                @csrf
                @method('PUT')
                <div class="w-1/2">
                ...
                <div class="w-1/2">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="$product->nama" 
                        required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-area id="deskripsi" class="block mt-1 w-full" name="deskripsi">{{ $product->deskripsi }}</x-text-area>
